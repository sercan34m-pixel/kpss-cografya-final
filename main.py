...
# --- DOSYA MOTORLARI (GÜNCELLENDİ: Android İçin Daha Güvenli) ---
def sorulari_yukle():
    # os.path.exists Android assetlerinde bazen hata verebilir.
    # Bu yüzden direkt okumaya çalışıp hata varsa yedeği dönüyoruz.
    try:
...
def main(page: ft.Page):
    # --- DÜZELTME: İKON SATIRI SİLİNDİ ---
    # page.window_icon satırı mobilde çökme yaratıyordu, kaldırdık.
    # -------------------------------------
    ...
    # --- YÜKLEME SİSTEMİ (Client Storage) ---
    def yukle():
        try:
